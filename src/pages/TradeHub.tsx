...
const TradeHub = () => {
  ...
  return (
    <div className="flex-1 space-y-3 p-4 md:p-6 pt-4 mx-auto flex flex-col items-center max-w-[100vw] overflow-x-hidden">
      {isLoading ? (
        ...
        <>
          <div className="space-y-3 w-full">
            <div className="flex gap-3 justify-start w-full overflow-hidden">
