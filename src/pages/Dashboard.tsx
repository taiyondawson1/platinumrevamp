...
const Dashboard = () => {
  ...
  return (
    <ScrollArea className="flex-1 w-full scrollarea-mobile-fix">
      <main className="p-2 sm:p-3 md:p-4 lg:p-5 pt-3 sm:pt-4 lg:pt-6 max-w-[1400px] mx-auto mobile-full-height">
        <div className="flex flex-col gap-2 sm:gap-3 md:gap-4">
          ...
          <div className="mobile-scroll-container">
            <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-12 gap-2 md:gap-3 min-h-[auto] sm:min-h-[20rem] lg:min-h-[25rem] w-full min-w-fit">
              <DashboardGridItem
