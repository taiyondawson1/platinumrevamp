...
const Sidebar = () => {
  ...
  return (
    <div className="fixed left-0 top-0 h-screen w-[270px] overflow-y-auto bg-gradient-to-br from-darkBlue via-darkBase to-darkGrey pt-[270px] px-[44px] z-[55]">
      {/* Navigation Box */}
      <div className="bg-darkGrey/30 backdrop-blur-sm border border-silver/20 p-4 w-full mb-4 !rounded-none">
