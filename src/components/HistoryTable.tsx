  ...
  return (
    <div className="w-full mt-4">
      ...
      <div className="relative overflow-auto" style={{ maxHeight: "480px" }}>
        <div className="min-w-[700px]"> {/* Force minimum width for smaller screens */}
          <Table>
              ...
              {history && history.length > 0 ? (
                history.map((trade, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell className="hidden sm:table-cell dark:text-white text-black">{trade.comment}</TableCell>
                  </TableRow>
                ))
              ) : (
                <TableRow>
