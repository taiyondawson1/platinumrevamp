...
function MainContent() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-darkBlue via-darkBase to-darkGrey">
      ...
      {!isHomePage && !isSetfilesPage && <Separator className="fixed left-0 right-0 top-[150px] z-50 bg-silver/20" />}
      <main className={`flex-1 ${!isHomePage && !isSetfilesPage ? "ml-[270px] mt-[150px]" : ""} relative`}>
